        ...
        return (
            <>
                <div className="border-transparent border-4 p-2 justify-center item-center rounded-lg" >
                    ...
                    <p className = "break-normal text-white w-[100%} text-left pt-5 pl-2 pr-2 pb-1">
                        This data has been sourced from the Nature Serve Explorer Web Api
                    </p>
                    <p className = "break-normal text-white w-[100%} text-left pl-2 pr-2">
