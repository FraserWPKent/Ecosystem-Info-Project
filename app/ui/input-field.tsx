...
export default function InputField(){
    ...
    return(
        <>
            <div className={` pb-[5vh] w-[66vw] drop-shadow-lg text-center  ${outputVisible > 0 ? 'pt-[5vh]' : 'pt-[30vh]'}`}>
            ...
            <div className={`flex flex-col md:grid lg:grid-cols-[80%_20%] md:grid-cols-[70%_30%] md:grid-flow-col md:gap-3 w-[75vw] items-center text-center items-center xs:text-left ${outputVisible > 0 ? 'pb-[5vh]' : 'pb-[35vh]'}`}>
            ...
            <div>
                <Suspense fallback={<p>Loading</p>}>
                    <div className = {`${outputVisible > 0 ? 'block' : 'hidden'}`}>
                        {outputElement}
                    </div>
                </Suspense>
            </div>
